  ...
  return (
    <div className='flex flex-col min-h-screen'>
        <div className='mt-3 flex flex-row gap-5'>
            ...
            <h1 className='text-center text-3xl'>Purchase Billing</h1>
        </div>
...
export const RowComp = ({
    ...
    return(
        <div className='col-span-8 grid grid-cols-6 border-t-2 p-2 border-neutral-800'>
            <div className='col-span-1' onKeyDown={(e)=>handleKeyPress(e,pcsRef, null )}>
                <SearchDropdown
            ...
            <div className='col-span-1' onKeyDown={(e)=>handleKeyPress(e, huidRef,null )}>
                <input
                 ref={pcsRef}
                 type='number'
                 value={pcs}
            ...
            <div className='col-span-1' onKeyDown={(e)=>handleKeyPress(e, wtRef,null )}>
                <input
                 ref={huidRef}
                 type='number'
                 value={HUID}
            ...
            <div className='col-span-1' onKeyDown={(e)=>handleKeyPress(e, tunchRef,null )}>
                <input
                 ref={wtRef}
                 type='number'
                 value={wt}
            ...
            <div className='col-span-1' onKeyDown={(e)=>handleKeyPress(e, null, fineRef)}>
                <input
                 ref={tunchRef}
                 type='number'
                 value={tunch}
            ...
            <div onClick={()=>setRows(rows=>rows+1)} className='col-span-1' ref={fineRef}>
